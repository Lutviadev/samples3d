...
@section('page-header')
	...
	@include('layouts.partials.path',['menu'=>'Renders Galleries', 'submenu'=>'Edit Gallery', 'icon'=>'wallpaper', 'route' => 'render_index'])

@endsection

@section('content')

	{!! Form::model($render, ['method' => 'PATCH', 'route' => ['render_update', $render->id], 'class' => 'form-horizontal', 'autocomplete' => 'off']) !!}	

	<div class="panel panel-default">

		<div class="panel-heading">	<h3 class="panel-title">Edit Gallery</h3> </div>
